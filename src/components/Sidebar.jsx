...
const navigation = [
  ...
  { name: 'DSA', href: '/dashboard/dsa', icon: BookOpenIcon },
  { name: 'Interview', href: '/dashboard/interview', icon: AcademicCapIcon },
  { name: 'AI Tutor', href: '/dashboard/ai-tutor', icon: SparklesIcon },
];
