...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simulate login logic here (e.g., authentication check)
    navigate('/dashboard');
  };
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-600 rounded bg-[#1a1a1a]"
                />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <a
                  href="#"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-[#1a1a1a] text-sm font-medium text-gray-400 hover:bg-gray-800"
                >
